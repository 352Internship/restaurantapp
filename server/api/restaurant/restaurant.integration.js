...
describe('Restaurant API:', function() {
  ...
  describe('GET /api/restaurants', function() {
    ...
    it('should respond with JSON array', function() {
      expect(restaurants).to.be.instanceOf(Array);
    });
  ...
  describe('POST /api/restaurants', function() {
    ...
    it('should respond with the newly created restaurant', function() {
      expect(newRestaurant.name).to.equal('New Restaurant');
      expect(newRestaurant.info).to.equal('This is the brand new restaurant!!!');
    });
  ...
  describe('GET /api/restaurants/:id', function() {
    ...
    it('should respond with the requested restaurant', function() {
      expect(restaurant.name).to.equal('New Restaurant');
      expect(restaurant.info).to.equal('This is the brand new restaurant!!!');
    });
  ...
  describe('PUT /api/restaurants/:id', function() {
    ...
    it('should respond with the updated restaurant', function() {
      expect(updatedRestaurant.name).to.equal('Updated Restaurant');
      expect(updatedRestaurant.info).to.equal('This is the updated restaurant!!!');
    });
